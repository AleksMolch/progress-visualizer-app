...
- [ ] 2.1 Настроить root layout (_layout.tsx).
- [ ] 2.2 Создать tabs layout с табами:
       Projects (index), Camera, Settings.
- [ ] 2.3 Создать экран проекта /project/[id].tsx.
- [ ] 2.4 Создать простые placeholder-экраны для каждого таба.
- [ ] 2.5 Проверить навигацию между табами и переход на экран проекта.
